...
using namespace RayTraceMoreTemp;

void init_RayTraceMoreTemp(GLFWwindow* window) {
	...
	raytraceComputeShader = Utils::createShaderProgram("RayCastingMoreTempComputeShader.glsl");
...
void displayRayTraceMoreTemp(GLFWwindow* window, double currentTime) {
	//=======================================================
...
int main(void) {
	...
	init_RayTraceMoreTemp(window);

	while (!glfwWindowShouldClose(window)) {
		displayRayTraceMoreTemp(window, glfwGetTime());
