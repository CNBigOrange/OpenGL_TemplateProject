...
using namespace RayTraceRecursion;

void init_RayTraceRecursion(GLFWwindow* window) {
	...
	raytraceComputeShader = Utils::createShaderProgram("RayCastingRecursionComputeShader.glsl");
...
void displayRayTraceRecursion(GLFWwindow* window, double currentTime) {
	//=======================================================
...
int main52(void) {
	...
	init_RayTraceRecursion(window);

	while (!glfwWindowShouldClose(window)) {
		displayRayTraceRecursion(window, glfwGetTime());
