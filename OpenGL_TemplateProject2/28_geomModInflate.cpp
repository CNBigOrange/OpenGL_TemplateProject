...
using namespace geomModInflate;
void installLightsGeomModInflate(glm::mat4 vMatrix) {
...
void setupVertices_GeomModInflate(void) {
...
void init_lightGeomModInflate(GLFWwindow* window) {
	...
	setupVertices_GeomModInflate();
}

void display_GeomModInflate(GLFWwindow* window, double currentTime) {
	...
	installLightsGeomModInflate(vMat);
...
int main28(void) {
	...
	init_lightGeomModInflate(window);

	while (!glfwWindowShouldClose(window)) {
		display_GeomModInflate(window, glfwGetTime());
