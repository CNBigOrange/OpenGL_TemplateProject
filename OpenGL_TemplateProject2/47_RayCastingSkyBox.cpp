...
using namespace RayTraceSkyBox;

void init_RayTraceSkyBox(GLFWwindow* window) {
	...
	raytraceComputeShader = Utils::createShaderProgram("RayCastingSkyBoxComputeShader.glsl");
...
void displayRayTraceSkyBox(GLFWwindow* window, double currentTime) {
	//=======================================================
...
int main47(void) {
	...
	init_RayTraceSkyBox(window);

	while (!glfwWindowShouldClose(window)) {
		displayRayTraceSkyBox(window, glfwGetTime());
