...
void init_light(GLFWwindow* window) {
...
void display_light(GLFWwindow* window, double currentTime) {
...
int main15(void) {
	...
	while (!glfwWindowShouldClose(window)) {
		display_light(window, glfwGetTime());
