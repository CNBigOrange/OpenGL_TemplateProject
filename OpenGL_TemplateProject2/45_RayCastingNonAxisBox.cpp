...
using namespace NonAxisBox;

void init_NonAxisBox(GLFWwindow* window) {
	...
	raytraceComputeShader = Utils::createShaderProgram("RayCastingNonAxisBoxComputeShader.glsl");
	screenQuadShader = Utils::createShaderProgram("RayCastingVertShader.glsl", "RayCastingFragShader.glsl");
}

void displayNonAxisBox(GLFWwindow* window, double currentTime) {
	//=======================================================
...
int main(void) {
	...
	init_NonAxisBox(window);

	while (!glfwWindowShouldClose(window)) {
		displayNonAxisBox(window, glfwGetTime());
