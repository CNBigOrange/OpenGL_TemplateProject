...
{	vec3 p00 = (gl_in[0].gl_Position).xyz;
	...
	// cubic Bezier basis functions立方贝塞尔基础函数
	...
	// output the position of this vertex in the tessellated patch输出曲面细分补丁中的顶点位置
	vec3 outputPosition =
...
//	gl_Position = mvp_matrix * vec4(u,0,v,1);               // shows original grid (pick one)
	...
	// output the interpolated texture coordinates输出插值过的纹理坐标
