...
using namespace std;
namespace RayTraceSingleRefraction {
...
using namespace RayTraceSingleRefraction;

void init_RayTraceSingleRefraction(GLFWwindow* window) {
	...
	raytraceComputeShader = Utils::createShaderProgram("RayCastingSingleRefractionComputeShader.glsl");
...
void displayRayTraceSingleRefraction(GLFWwindow* window, double currentTime) {
	//=======================================================
...
int main50(void) {
	...
	init_RayTraceSingleRefraction(window);

	while (!glfwWindowShouldClose(window)) {
		displayRayTraceSingleRefraction(window, glfwGetTime());
