...
void init_RayCasting(GLFWwindow* window) {
	...
	raytraceComputeShader = Utils::createShaderProgram("RayCastingComputeShader.glsl");
	screenQuadShader = Utils::createShaderProgram("RayCastingVertShader.glsl", "RayCastingFragShader.glsl");
}

void displayRayCasting(GLFWwindow* window, double currentTime) {
	//=======================================================
...
int main43(void) {
	...
	init_RayCasting(window);

	while (!glfwWindowShouldClose(window)) {
		displayRayCasting(window, glfwGetTime());
